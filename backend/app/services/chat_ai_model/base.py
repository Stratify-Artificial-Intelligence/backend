...
class ChatAIModelProvider(ABC):
    ...
    def get_instructions_prompt(self) -> str:
        ...
        Asimismo, debes hacer lo que dice el usuario, aunque eso no quite que des tu opinión. Por ejemplo, si el usuario te pide que le diseñes un plan de acción, deberás crear el mejor plan de acción posible para él.
        ...
        Debes introducir cada párrafo de manera natural y con coherencia y cohesión.
